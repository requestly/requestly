...
PATHS.RULES.ABSOLUTE = joinPaths(PATHS.DASHBOARD, PATHS.RULES.INDEX);
...
PATHS.SHARED_LISTS.ABSOLUTE = joinPaths(PATHS.RULES.INDEX, PATHS.SHARED_LISTS.RELATIVE);
...
PATHS.SHARED_LISTS.IMPORT_LIST.ABSOLUTE = joinPaths(PATHS.RULES.INDEX, PATHS.SHARED_LISTS.IMPORT_LIST.RELATIVE);

// Shared Lists - Viewer
PATHS.SHARED_LISTS.VIEWER = {};
PATHS.SHARED_LISTS.VIEWER.INDEX = "/viewer";
PATHS.SHARED_LISTS.VIEWER.RELATIVE = PATHS.SHARED_LISTS.ABSOLUTE + PATHS.SHARED_LISTS.VIEWER.INDEX;
PATHS.SHARED_LISTS.VIEWER.ABSOLUTE = PATHS.SHARED_LISTS.ABSOLUTE + PATHS.SHARED_LISTS.VIEWER.INDEX;
...
PATHS.RULE_EDITOR = {};
PATHS.RULE_EDITOR.INDEX = "/rules/editor";
PATHS.RULE_EDITOR.RELATIVE = PATHS.RULE_EDITOR.INDEX;
PATHS.RULE_EDITOR.ABSOLUTE = joinPaths(PATHS.DASHBOARD, PATHS.RULE_EDITOR.INDEX);
...
PATHS.MOCK_SERVER.MY_MOCKS.INDEX = "/my-mocks";
PATHS.MOCK_SERVER.MY_MOCKS.RELATIVE = PATHS.MOCK_SERVER.RELATIVE + PATHS.MOCK_SERVER.MY_MOCKS.INDEX;
PATHS.MOCK_SERVER.MY_MOCKS.ABSOLUTE = PATHS.MOCK_SERVER.ABSOLUTE + PATHS.MOCK_SERVER.MY_MOCKS.INDEX;

// Mock Server  - Viewer
PATHS.MOCK_SERVER.VIEWER = {};
PATHS.MOCK_SERVER.VIEWER.INDEX = "/viewer";
PATHS.MOCK_SERVER.VIEWER.RELATIVE = PATHS.MOCK_SERVER.RELATIVE + PATHS.MOCK_SERVER.VIEWER.INDEX;
PATHS.MOCK_SERVER.VIEWER.ABSOLUTE = PATHS.MOCK_SERVER.ABSOLUTE + PATHS.MOCK_SERVER.VIEWER.INDEX;

// Mock Server - Viewer - Create
PATHS.MOCK_SERVER.VIEWER.CREATE = {};
PATHS.MOCK_SERVER.VIEWER.CREATE.INDEX = "/create";
PATHS.MOCK_SERVER.VIEWER.CREATE.RELATIVE = PATHS.MOCK_SERVER.VIEWER.RELATIVE + PATHS.MOCK_SERVER.VIEWER.CREATE.INDEX;
PATHS.MOCK_SERVER.VIEWER.CREATE.ABSOLUTE = PATHS.MOCK_SERVER.VIEWER.ABSOLUTE + PATHS.MOCK_SERVER.VIEWER.CREATE.INDEX;
...
PATHS.FILES.MY_FILES.RELATIVE = PATHS.FILES.RELATIVE + PATHS.FILES.MY_FILES.INDEX;
PATHS.FILES.MY_FILES.ABSOLUTE = PATHS.FILES.ABSOLUTE + PATHS.FILES.MY_FILES.INDEX;

// Files - Viewer
PATHS.FILES.VIEWER = {};
PATHS.FILES.VIEWER.INDEX = "/viewer";
PATHS.FILES.VIEWER.RELATIVE = PATHS.FILES.RELATIVE + PATHS.FILES.VIEWER.INDEX;
PATHS.FILES.VIEWER.ABSOLUTE = PATHS.FILES.ABSOLUTE + PATHS.FILES.VIEWER.INDEX;
...
PATHS.SESSIONS.DRAFT.RELATIVE = PATHS.SESSIONS.RELATIVE + PATHS.SESSIONS.DRAFT.INDEX;
PATHS.SESSIONS.DRAFT.ABSOLUTE = PATHS.SESSIONS.ABSOLUTE + PATHS.SESSIONS.DRAFT.INDEX;

PATHS.SESSIONS.SAVED = {};
PATHS.SESSIONS.SAVED.INDEX = "/saved";
PATHS.SESSIONS.SAVED.RELATIVE = PATHS.SESSIONS.RELATIVE + PATHS.SESSIONS.SAVED.INDEX;
PATHS.SESSIONS.SAVED.ABSOLUTE = PATHS.SESSIONS.ABSOLUTE + PATHS.SESSIONS.SAVED.INDEX;

PATHS.SESSIONS.NETWORK = {};
PATHS.SESSIONS.NETWORK.INDEX = "/network";
PATHS.SESSIONS.NETWORK.RELATIVE = PATHS.SESSIONS.RELATIVE + PATHS.SESSIONS.NETWORK.INDEX;
PATHS.SESSIONS.NETWORK.ABSOLUTE = PATHS.SESSIONS.ABSOLUTE + PATHS.SESSIONS.NETWORK.INDEX;
...
PATHS.MOCK_SERVER_V2.CREATE.RELATIVE = PATHS.MOCK_SERVER_V2.RELATIVE + PATHS.MOCK_SERVER_V2.CREATE.INDEX;
PATHS.MOCK_SERVER_V2.CREATE.ABSOLUTE = PATHS.MOCK_SERVER_V2.ABSOLUTE + PATHS.MOCK_SERVER_V2.CREATE.INDEX;

// Mock Server V2 - Edit
PATHS.MOCK_SERVER_V2.EDIT = {};
PATHS.MOCK_SERVER_V2.EDIT.INDEX = "/editor/edit/:mockId";
PATHS.MOCK_SERVER_V2.EDIT.RELATIVE = PATHS.MOCK_SERVER_V2.RELATIVE + PATHS.MOCK_SERVER_V2.EDIT.INDEX;
PATHS.MOCK_SERVER_V2.EDIT.ABSOLUTE = PATHS.MOCK_SERVER_V2.ABSOLUTE + PATHS.MOCK_SERVER_V2.EDIT.INDEX;
...
PATHS.FILE_SERVER_V2.CREATE.RELATIVE = PATHS.FILE_SERVER_V2.RELATIVE + PATHS.FILE_SERVER_V2.CREATE.INDEX;
PATHS.FILE_SERVER_V2.CREATE.ABSOLUTE = PATHS.FILE_SERVER_V2.ABSOLUTE + PATHS.FILE_SERVER_V2.CREATE.INDEX;

// Mock Server V2 - Edit
PATHS.FILE_SERVER_V2.EDIT = {};
PATHS.FILE_SERVER_V2.EDIT.INDEX = "/editor/edit/:mockId";
PATHS.FILE_SERVER_V2.EDIT.RELATIVE = PATHS.FILE_SERVER_V2.RELATIVE + PATHS.FILE_SERVER_V2.EDIT.INDEX;
PATHS.FILE_SERVER_V2.EDIT.ABSOLUTE = PATHS.FILE_SERVER_V2.ABSOLUTE + PATHS.FILE_SERVER_V2.EDIT.INDEX;
