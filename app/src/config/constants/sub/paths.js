...
PATHS.WEB_TRAFFIC_TABLE = {};
PATHS.WEB_TRAFFIC_TABLE.RELATIVE = "/web-traffic-table";
PATHS.WEB_TRAFFIC_TABLE.ABSOLUTE = joinPaths(PATHS.DASHBOARD, PATHS.WEB_TRAFFIC_TABLE.RELATIVE);
