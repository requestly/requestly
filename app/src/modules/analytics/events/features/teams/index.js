...
export const trackWorkspaceInviteAccepted = (team_id, invite_id, source, usage_type, members_count) => {
  const params = { team_id, source, invite_id, usage_type, members_count };
