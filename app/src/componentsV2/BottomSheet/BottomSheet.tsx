...
export const BottomSheet: React.FC<BottomSheetProps> = ({
  ...
  const verticalTabExtraContent = (
    <div className="bottom-sheet-tab-extra-content">
      ...
      <div className="bottom-sheet-utilites">
        ...
        {disableDocking ? null : (
          <Tooltip title={isSheetPlacedAtBottom ? "Dock to right" : "Dock to bottom"} color="#000" placement="bottom">
            <RQButton
              size="small"
              type="transparent"
  ...
  const horizontalTabExtraContent = {
    ...
    right: (
      <Tooltip title={isSheetPlacedAtBottom ? "Dock to right" : "Dock to bottom"} color="#000" placement="left">
        <RQButton
          size="small"
          type="transparent"
          onClick={() => toggleSheetPlacement()}
