...
import { secretsManagerReducerWithPersist } from "features/apiClient/slices/secrets-manager/slice";
...
export const reduxStore = configureStore({
  reducer: {
    ...
    [ReducerKeys.SECRETS_MANAGER]: secretsManagerReducerWithPersist,
  },
