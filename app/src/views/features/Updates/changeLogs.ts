...
const changeLogs: VersionedChangeLogs[] = [
  {
    ...
    logs: [
      {
        title:
          "Bug fix: Rule status toggled from extension popup gets reverted on opening app",
        link: "https://github.com/requestly/requestly/issues/540",
      },
      {
        title:
          "Bug fix: UI app breaks due to some rules matching requests originated from app",
