...
const mockNetworkEvents: NetworkEventData[] = [
  ...
  },
  {
    ...
    response:
      '{"userId":1,"id":1,"title":"Apple is an American technology company.","completed":false}',
    status: 200,
    responseTime: 328,
  ...
  },
  {
    ...
    responseURL:
      "https://github.com/requestly/requestly-demo/issues/100000/labels",
  ...
  },
  {
    ...
    method: "GET",
    url:
      "https://github.com/requestly/requestly-demo/show_partial?partial=tree%2Frecently_touched_branches_list",
    requestData: {
  ...
  },
  {
    ...
    method: "GET",
    url:
      "https://github.com/requestly/requestly-demo/my_forks_menu_content?can_fork=true",
    requestData: {
      can_fork: true,
    },
    response:
