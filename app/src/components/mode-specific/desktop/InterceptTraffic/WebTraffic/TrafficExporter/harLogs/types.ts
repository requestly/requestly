import { Log as ConsoleLog } from "capture-console-logs/dist/logs";
...
export interface RQExtraDetails {
  id: string; // request ID
  consoleLogs: ConsoleLog[]; // array of console logs generated by script
  domain: string;
  app: string;
  duration: number;
}
