...
const pricingButtonsMap: Record<string, any> = {
  default: {
    [PRICING.PLAN_NAMES.FREE]: {
      ...
      [PRICING.PLAN_NAMES.LITE]: CTA_BUTTONS_CONFIG.checkout,
    ...
    [PRICING.PLAN_NAMES.LITE]: {
      ...
      [PRICING.PLAN_NAMES.LITE]: CTA_BUTTONS_CONFIG["current-plan"],
    ...
    [PRICING.PLAN_NAMES.BASIC]: {
      [PRICING.PLAN_NAMES.FREE]: CTA_BUTTONS_CONFIG["not-visible"],
      [PRICING.PLAN_NAMES.LITE]: CTA_BUTTONS_CONFIG["switch-plan"],
  ...
  trial: {
    [PRICING.PLAN_NAMES.FREE]: CTA_BUTTONS_CONFIG["not-visible"],
    [PRICING.PLAN_NAMES.LITE]: CTA_BUTTONS_CONFIG["manage-subscription"],
