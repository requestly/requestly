...
const pricingButtonsMap: Record<string, any> = {
  default: {
    [PRICING.PLAN_NAMES.FREE]: {
      ...
      [PRICING.PLAN_NAMES.API_CLIENT_PROFESSIONAL]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.CHECKOUT],
    },
    ...
    [PRICING.PLAN_NAMES.ENTERPRISE]: {
      ...
      [PRICING.PLAN_NAMES.API_CLIENT_PROFESSIONAL]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.NOT_VISIBLE],
    ...
    [PRICING.PLAN_NAMES.API_CLIENT_ENTERPRISE]: {
      ...
      [PRICING.PLAN_NAMES.BASIC]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.ADD_PLAN],
      [PRICING.PLAN_NAMES.PROFESSIONAL]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.UPGRADE],
      [PRICING.PLAN_NAMES.ENTERPRISE]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.UPGRADE],
      [PRICING.PLAN_NAMES.API_CLIENT_PROFESSIONAL]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.SWITCH_PLAN],
      [PRICING.PLAN_NAMES.API_CLIENT_ENTERPRISE]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.CURRENT_PLAN],
    },
  },
  trial: {
    ...
    [PRICING.PLAN_NAMES.API_CLIENT_PROFESSIONAL]: CTA_BUTTONS_CONFIG[CTA_CONFIG_SELECTORS.MANAGE_SUBSCRIPTION],
  },
};
