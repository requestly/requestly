    ...
    <div className="grr-warning-message-container">
      ...
      <div className="grr-warning-content">
        ...
        <div className="grr-warning-message-description">
          ...
          which mandates you to use compliant products. Write us at <a href="#">contact@requestly.com</a> or contact
          your BrowserStack Customer Success Manager to discuss continued usage of this product
        </div>
      </div>
    </div>
  );
