...
type StateWithRecords = { apiRecords: ApiRecordsState };

const selectRecordsSlice = (state: StateWithRecords) => state.apiRecords;
...
export const selectParentId = createSelector(
  [selectChildToParent, (_state: StateWithRecords, id: EntityId) => id],
...
export const selectChildrenIds = createSelector(
  [selectParentToChildren, (_state: StateWithRecords, id: EntityId) => id],
...
export const selectRecordsByCollectionId = createSelector(
  [selectAllRecords, (_state: StateWithRecords, collectionId: EntityId | null) => collectionId],
  (records, collectionId) => records.filter((r) => r.collectionId === collectionId)
);

export const selectRecordsByType = createSelector(
  [selectAllRecords, (_state: StateWithRecords, type: RQAPI.RecordType) => type],
  (records, type) => records.filter((r) => r.type === type)
);

export const selectIsRecordLoaded = createSelector(
  [selectRecordsEntities, (_state: StateWithRecords, id: EntityId) => id],
...
export const makeSelectChildrenIds = () =>
  createSelector([selectParentToChildren, (_state: StateWithRecords, id: EntityId) => id], (parentToChildren, id) =>
    getImmediateChildren(id, parentToChildren)
  );

export const makeSelectAncestorIds = () =>
  createSelector([selectChildToParent, (_state: StateWithRecords, id: EntityId) => id], (childToParent, id) =>
