...
export interface AutogeneratedFieldsStore {
  ...
  purgeAndAdd: (namespace: Namespace, headers: Record<string, string>, queryParams: KeyValuePair[]) => void;
}
...
export const createAutogeneratedStore = (entry?: RQAPI.Entry) => {
  return create<AutogeneratedFieldsStore>()((set, get) => ({
    ...
    purgeAndAdd: (namespace: Namespace, headers: Record<string, string>, queryParams: KeyValuePair[]) => {
