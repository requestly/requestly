...
export interface AutogeneratedFieldsStore {
  ...
  purgeAndAdd: (namespace: AutogeneratedFieldsNamespace, headers: Record<string, string>, queryParams: SimpleKeyValuePair[]) => void;
}
...
function parseContentType(contentType: RequestContentType): NamespaceContents {
...
export const createAutogeneratedStore = (entry?: RQAPI.Entry) => {
  return create<AutogeneratedFieldsStore>()((set, get) => ({
    ...
    purgeAndAdd: (namespace: AutogeneratedFieldsNamespace, headers: Record<string, string>, queryParams: SimpleKeyValuePair[]) => {
