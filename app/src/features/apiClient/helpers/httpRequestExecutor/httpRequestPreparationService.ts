...
export class HttpRequestPreparationService {
   ...
   */
  private buildStoreOverrideFromContext(recordId: string, context: ExecutionContext): StoreOverrideConfig {
    ...
    const config: StoreOverrideConfig = {
      ...
      collectionVariables: effectiveCollectionId ? { [effectiveCollectionId]: context.collectionVariables } : undefined,
    };
  ...
  private extractVariablesFromContext(
    ...
    const storeOverrideConfig = this.buildStoreOverrideFromContext(recordId, context);
  ...
  prepareRequest(
    ...
    const { scopedVariables } = this.getVariables(recordId, {
      storeOverrideConfig: executionContext
        ? this.buildStoreOverrideFromContext(recordId, executionContext)
        : undefined,
      scopes,
    });
