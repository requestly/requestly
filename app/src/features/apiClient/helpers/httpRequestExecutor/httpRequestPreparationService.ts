...
import { renderVariables, renderVariables as renderVariablesType } from "backend/environment/utils";
...
export class HttpRequestPreparationService {
  ...
  prepareRequest(
    ...
    //what is scope is this required here?
    ...
    renderedEntry.request.headers = updateRequestWithAuthOptions(workingEntry.request.headers, headers);
    renderedEntry.request.queryParams = updateRequestWithAuthOptions(workingEntry.request.queryParams, queryParams);
