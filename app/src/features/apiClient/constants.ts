...
import { KeyValuePair, RequestMethod, RQAPI } from "./types";
...
export const EXAMPLE_COLLECTIONS = {
  records: [
    {
      name: "Hacker News APIs",
      type: "collection" as RQAPI.RecordType.COLLECTION,
      createdBy: "rS3kiehD9cZBIPSmryxQ99DcUCrz",
      createdTs: 1737987177362,
      updatedBy: "rS3kiehD9cZBIPSmryxQ99DcUCrz",
      updatedTs: 1737987177362,
      ownerId: "rS3kiehD9cZBIPSmryxQ99DcUCrz",
      data: {
        variables: {
          url: {
            id: 0,
      ...
      id: "U5HvE3qijbx2d423Gl4O",
    },
    {
      name: "Best Stories",
      type: "api" as RQAPI.RecordType.API,
      createdBy: "rS3kiehD9cZBIPSmryxQ99DcUCrz",
      createdTs: 1737987177362,
      updatedBy: "rS3kiehD9cZBIPSmryxQ99DcUCrz",
      updatedTs: 1737987177362,
      ...
      data: {
        request: {
          ...
          method: "GET" as RequestMethod.GET,
          queryParams: [
            {
              id: 0,
              key: "print",
      ...
      collectionId: "U5HvE3qijbx2d423Gl4O",
      deleted: false,
      id: "viTbyNTgdCOsdY6oq5Fn",
    },
    {
      name: "New Stories",
      type: "api" as RQAPI.RecordType.API,
