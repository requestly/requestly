    ...
    (contentType: RequestContentType) => {
      setEntry((entry) => {
        const newEntry: RQAPI.Entry = {
          ...
          request: {
            ...entry.request,
            body: contentType === RequestContentType.urlEncodedForm ? [] : "",
            contentType,
          },
        };
        ...
        const prettyValue =
          contentType === RequestContentType.multiPartForm
            ? "multipart/form-data boundary<calculated at runtime>"
            : undefined;

        purgeAndAddHeaders(AutogeneratedFieldsNamespace.CONTENT_TYPE, {
          [contentTypeHeader.key]: { value: contentTypeHeader.value, prettyValue },
        });
