...
import { AutogeneratedFieldsNamespace, parseAuth, SimpleKeyValuePair } from "features/apiClient/store/autogenerateStore";
...
const APIClientView: React.FC<Props> = ({
  ...
  const handleAuthChange = useCallback(
    (newAuth: RQAPI.Auth) => {
      const { headers, queryParams } = parseAuth(newAuth, resolver);
