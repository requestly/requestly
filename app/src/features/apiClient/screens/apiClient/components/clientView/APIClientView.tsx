    ...
    (contentType: RequestContentType) => {
      setEntry((entry) => {
        const newEntry: RQAPI.Entry = {
          ...
          request: {
            ...entry.request,
            body: contentType === RequestContentType.URL_ENCODED_FORM ? [] : "",
            contentType,
          },
        };
        ...
        purgeAndAddHeaders(AutogeneratedFieldsNamespace.CONTENT_TYPE, {
          [contentTypeHeader.key]: getResolvedHeaders(contentType),
        });

        if (contentType === RequestContentType.JSON) {
          newEntry.request.body = "{}";
        } else if (contentType === RequestContentType.URL_ENCODED_FORM) {
          newEntry.request.body = [];
        } else {
          newEntry.request.body = "";
        }
