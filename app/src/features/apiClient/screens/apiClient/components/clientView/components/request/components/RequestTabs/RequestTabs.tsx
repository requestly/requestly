...
interface Props {
  ...
  getAuthOptions: () => { headers: KeyValuePair[]; queryParams: KeyValuePair[] };
}
...
const RequestTabs: React.FC<Props> = ({
  ...
  const tabItems: TabsProps["items"] = useMemo(() => {
    ...
    const autoGeneratedQueryParams = getAuthOptions().queryParams;
    const autoGeneratedHeaders = getAuthOptions().headers;
