...
export const HeadersTable: React.FC<HeadersTableProps> = ({ headers, variables, setRequestEntry }) => {
  const [version, getAllHeaders] = useAutogenerateStore((s) => [s.headerVersion, s.getAllHeaders]);

  const autogeneratedHeaders = useMemo(() => getAllHeaders(), [version, getAllHeaders]);
