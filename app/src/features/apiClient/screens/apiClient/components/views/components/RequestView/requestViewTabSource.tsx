...
import { createAutogeneratedStore } from "features/apiClient/store/autogenerateStore";
...
export class RequestViewTabSource extends BaseTabSource {
  ...
  createViewStore() {
    ...
    const autogenerateStore = createAutogeneratedStore();
    const store = createRequestViewStore(metadata.apiEntryDetails, autogenerateStore);
