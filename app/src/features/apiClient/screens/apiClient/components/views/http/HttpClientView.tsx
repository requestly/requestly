  ...
  useEffect(() => {
    if (!apiClientExecutor) {
      setApiClientExecutor(
        new HttpRequestExecutor(appMode, apiClientWorkloadManager, autoGeneratedStore, apiClientFilesStore)
      );
    }
  }, [apiClientWorkloadManager, appMode, apiClientExecutor, autoGeneratedStore, apiClientFilesStore]);
