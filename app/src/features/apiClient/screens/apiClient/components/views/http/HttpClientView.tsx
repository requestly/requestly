...
const HttpClientView: React.FC<Props> = ({
  ...
  const {
    ...
    api: { patchCollectionVariables, updateIdIfChanged },
  } = useCommand();
  ...
  const apiClientExecutorRef = useRef<HttpRequestExecutor | null>(null);
  ...
  useEffect(() => {
    apiClientExecutorRef.current = new HttpRequestExecutor(
      apiEntryDetails.id,
      ctx,
      appMode,
        ...
        <div className="api-client-header-container__header">
          <div className="api-client-breadcrumb-container">
            ...
            <ClientCodeButton
              ...
              apiClientExecutor={apiClientExecutorRef.current}
            />
          </div>
