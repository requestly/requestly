  ...
  useEffect(() => {
    if (!graphQLRequestExecutor) {
      setGraphQLRequestExecutor(
        new GraphQLRequestExecutor(appMode, apiClientWorkloadManager, autoGeneratedStore, apiClientFilesStore)
      );
    }
  }, [apiClientWorkloadManager, appMode, graphQLRequestExecutor, autoGeneratedStore, apiClientFilesStore]);
