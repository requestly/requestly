...
import { AutogeneratedFieldsNamespace } from "features/apiClient/store/autogenerateStore";
...
const GraphQLClientView: React.FC<Props> = ({
  ...
  }, [getRecord, graphQLRequestExecutor, updateRecordResponse, updateRecordTestResults, resetState]);
