# Requestly Plugin Evals

These eval cases check the behavior of the `requestly-api-workflow` agent plugin, not Requestly itself. They are meant to verify that the plugin produces useful plans, safe boundaries, and concrete acceptance checks for common Requestly workflows.
